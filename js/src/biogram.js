    ...
    $(document).ready(function() {
        ...
        for (var i = 0; i < max1; i++) {
            ...
            if (institute.length) {
                ...
                } else if (instituteVal[2].length !== 0) {
                    occupation += instituteVal[2];
                } else {
            ...
            if (center.length) {
                ...
                } else if (centerVal[2].length !== 0) {
                    occupation += centerVal[2];
                } else {
        ...
        for (var i = 0; i < max2; i++) {
            ...
            if (department.length) {
                ...
                if (departmentVal[0] && departmentVal[2]) {
                    occupation += departmentVal[0] + ' ' + departmentVal[1] + ' ' + departmentVal[2];
                } else if (departmentVal[2] !== 0) {
                    occupation += departmentVal[2]
                } else {
            ...
            if (cathedral.length) {
                ...
                if (cathedralVal[0] && cathedralVal[2]) {
                    occupation += cathedralVal[0] + ' ' + cathedralVal[1] + ' ' + cathedralVal[2];
                } else if (cathedralVal[2] !== 0) {
                    occupation += cathedralVal[2]
                } else {
