...
<link rel="manifest" href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/manifest.json"> -->
  ...
  <style>@font-face{font-family:icomoon;src:url(<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/fonts2/icomoon.woff?d6ozg7) format("woff");font-weight:400;font-style:normal;font-display:block}</style>
  ...
  <body <?php echo 'class="'.htmlspecialchars($pageclass_sfx) . htmlspecialchars($pageclass).' aid' . $id; echo $additionalPageClass .' ' . $catidCalssAdd. '"'; ?>>
   <?php
    ...
    <script>
     ...
     _etmc.push(["trackPageView", {"item": "swps<?php echo $id;?>"}]);
     </script>
	 <?php
   	}
     ?>
